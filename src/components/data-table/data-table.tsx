...
export function DataTable<TData extends BaseRecord>({
  ...
  return (
    <div className={cn("flex", "flex-col", "flex-1", "gap-4")}>
      <div ref={tableContainerRef} className={cn("rounded-md", "border", "relative", "bg-card")}>
        <Table ref={tableRef} style={{ tableLayout: "fixed", width: "100%" }} className={cn(isFetching && !isLoading && "pointer-events-none")}>
          <TableHeader>
              ...
              <TableRow key={headerGroup.id}>
                {headerGroup.headers.map((header) => {
                  ...
                  return (
                    ...
                    >
                      {
                        isPlaceholder ? null : <DataTableColumnHeader header={header} title={String(header.column.columnDef.header)} />
                      }
                      {/* {isPlaceholder ? null : (
                        <div className={cn("flex", "items-center", "gap-1")}>
                          ...
                          {sortable && <DataTableSorter column={header.column} />}
                        </div>
                      )} */}
                    </TableHead>
                  );
                ...
                return (
                  ...
                  >
                    {row.getVisibleCells().map((cell) => {
                      // console.log("cell", cell, cell.column.columnDef.cell,cell.getContext());
