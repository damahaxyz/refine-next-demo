...
export function DataTablePagination<TData extends BaseRecord>({
  table
  ...
  if (tableQuery.isLoading || getRowModel().rows?.length === 0) {
    return null;
  }
    ...
    >
      ...
      <div className={cn("flex", "items-center", "flex-wrap", "gap-2")}>
        <div className={cn("flex", "items-center", "gap-2")}>
          <span className={cn("text-sm", "font-medium")}>每页显示</span>
          <Select
            value={`${pageSize}`}
