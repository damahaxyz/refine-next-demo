...
export const ProductEditForm = () => {
    ...
    return (
        <div className="container mx-auto py-6 max-w-[1600px]">
            {/* Header */}
            <div className="flex items-center justify-between mb-6 sticky top-0 bg-background/95 backdrop-blur z-50 py-4 border-b">
                <div className="flex items-center gap-4">
                    <Button variant="outline" size="icon" onClick={handleBack}>
                        <ArrowLeft className="h-4 w-4" />
                    </Button>
                    <div>
                        <h1 className="text-2xl font-bold tracking-tight">商品编辑 (对比模式)</h1>
                                                    ...
                                                    <div key={val.id || vIndex} className="flex gap-2 items-center bg-muted/10 p-1.5 rounded border border-dashed">
                                                        <div className="w-8 h-8 shrink-0">
                                                            <ImageEdit
                                                                ...
                                                                onChange={(newVal) => form.setValue(`attributes.${index}.values.${vIndex}.image`, newVal)}
